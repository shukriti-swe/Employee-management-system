...
<!--navigation bar end-->
  <div class="sidebar">
  <a class="active" href="{{ route('service') }}"><i class='fas fa-diagnoses'></i><b>Our service</b></a>
  <a href="{{ route('photos') }}"><i class='far fa-images' ></i><b>Photos</b></a>
  <a href="{{ route('contact') }}"><i class='far fa-envelope' ></i><b>Contact Us</b></a>
  <a href="{{ route('description') }}"><i class="fa fa-file-text"></i><b>Description</b></a>
</div>
 <div class="main">
